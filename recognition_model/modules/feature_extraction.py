...
class VGG_KOR_FeatureExtractor(nn.Module):
    ...
    def __init__(self, input_channel, output_channel=512):
        super(VGG_KOR_FeatureExtractor, self).__init__()
        ...
        self.ConvNet = nn.Sequential(
            ...
            nn.Conv2d(self.output_channel[1], self.output_channel[2], 3, 1, 1), nn.ReLU(True),  # 256x20x60
            nn.Conv2d(self.output_channel[2], self.output_channel[2], 3, 1, 1), nn.ReLU(True),
            nn.MaxPool2d((2, 2), (2, 2)),  # 256x10x30
            nn.Conv2d(self.output_channel[2], self.output_channel[3], 3, 1, 1, bias=False),
            nn.BatchNorm2d(self.output_channel[3]), nn.ReLU(True),  # 512x10x30
